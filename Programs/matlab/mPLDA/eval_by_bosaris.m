function [eer, dcf12, res12] = eval_by_bosaris(sre12_evlfile, sre12_keyfile, fast_keyloading) 
...
% setup_bosaris('~/so/Matlab/bosaris');       % Assuming ~/so/Matlab/bosaris contains the toolkit

% Load key. If .mat file for key has been saved, it is quicker to load the .mat file
if (strcmp(fast_keyloading,'true') == 1),
